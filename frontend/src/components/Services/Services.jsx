...
const Services = () => {
  const products = [
    ...
    },
    {
      ...
      name: "Achievements",
      description:
        "Showcase your accomplishments, honor your peers, and get inspired by the achievements within our alumni network",
      slug: "achievements",
      imageSrc:
...

    {
      ...
      description:
        "Find exclusive job postings from alumni-owned businesses, get career advice, and access resources to advance your professional journey",
      slug: "career",
      imageSrc:
